        ...
        <div class="row">
          ...
          <div class="col span-1-of-2">
            <div class="product-grid2">
                <div class="product-image2">
                    <a href="#">
                        <img class="pic-1 makebig" src="images/1.jpeg">
                        <img class="pic-2" src="images/1.jpeg">
                    </a>
                    <ul class="social">
                        <li><a href="#">
                          <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="row">
            <div class="col span-1-of-2">
                <div class="product-grid2">
                    <div class="product-image2">
                        <a href="#">
                            <img class="pic-1" src="images/5.jpeg">
                            <img class="pic-2" src="images/5.jpeg">
                        </a>
                        <ul class="social">
                            <li><a href="#">
                              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="product-content">
                        <h3 class="title"><a href="#">Mental Health and Transitiong</a></h3>
                        <span class="price">Mental health challenges are common. In fact, one in five people will experience a mental illness like depression or anxiety. But unfortunately in the transgender community, that number is even higher at nearly one in two. Even worse, 41 percent have attempted suicide.It’s important to know, though, that we can help. And that starts with educating ourselves and offering support.<u>Cont..</u></span>
                    </div>
                </div>
            </div>
            <div class="col span-1-of-2">
